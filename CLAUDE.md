...
3. **Icons:** Replace all existing FontAwesome icons (`fa-`, `fas-`, `fab-`) with **Lucide Icons** (`flaticon`).
...
2. **Map Icons:** Find all FontAwesome classes used in the old HTML and map them to their closest equivalent in `flaticon`.
